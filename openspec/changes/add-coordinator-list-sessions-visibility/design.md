...
### 2. Coordinator marking is the gate

Only Coordinator-marked connections should receive widened list scope. Ordinary Agent Mode callers must keep their existing child-scoped behavior.
