...
- Show a Coordinator rail when a Coordinator can be selected or detected, plus a grouped agent inbox with read-only within-group sorting, optional inspector / trailing detail column, compact MCP footer/popover, and deep links back to Agent Mode.
