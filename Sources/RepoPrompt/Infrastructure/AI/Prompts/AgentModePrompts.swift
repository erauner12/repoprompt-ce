...
enum AgentModePrompts {
    ...
    enum Fragments {
        ...
        **Coordinator runtime demo mode**
        ...
        - The Mission policy snapshot may be adjusted by the app mid-mission. Re-read the current `policy_snapshot` and `autonomy_summary` from `coordinator_chat op=mission_status` at each boundary before deciding whether to pause, continue, or answer child questions.
