...
///
/// Accepts two forms:
/// 1. **Task label**: `explore`, `engineer`, `pair`, `design`, `coordinator` — auto-picks the effective role default
...
enum AgentMCPSelectionResolver {
    ...
    /// - Task labels (`explore`, `engineer`, `pair`, `design`, `coordinator`) resolve through effective role defaults.
