    ...
    private func coordinatorChatTool() -> Tool {
        runtime.tool(
            ...
            **Operations**: list | select | new | ensure_mission | start_mission | stop_mission | submit | mission_plan | mission_status | mission_events | receipt | set_pace | set_autonomy | wait_for_update
            ...
            - `submit`: Send a directive to the selected parent, to `coordinator_session_id`, or to a fresh parent when `new_parent=true`. For `checkpoint_action`, pass the `expected_checkpoint_instance_id` read from compact `mission_status` to reject stale approval clicks after plan revision.
            ...
            inputSchema: .object(
                ...
                **wait_for_update**: coordinator_session_id?, since_fingerprint?, timeout_seconds?; waits until compact mission_status.fingerprint changes and returns compact status.
                ...
                properties: [
                    ...
                    "expected_checkpoint_instance_id": .string(description: "[submit] Optional stale-submit guard for checkpoint_action. Use checkpoint.checkpoint_instance_id or action.expected_checkpoint_instance_id from compact mission_status; mismatches are rejected."),
