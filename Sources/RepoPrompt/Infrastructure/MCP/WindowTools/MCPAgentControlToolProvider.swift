        ...
        runtime.tool(
            ...
            **Operations**: list | list_missions | doctor | select | new | ensure_mission | start_mission | stop_mission | archive_mission | submit | mission_plan | mission_status | mission_events | receipt | set_pace | set_autonomy | wait_for_update
            ...
            inputSchema: .object(
                ...
                **submit**: message (required unless checkpoint_action is present), coordinator_session_id? or new_parent?, coordinator_model_id? with new_parent, checkpoint_action?, expected_checkpoint_instance_id?, compact?; returns compact state by default for external automation unless compact=false.
