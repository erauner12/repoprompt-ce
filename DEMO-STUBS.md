...
- The loopback proof child is intentionally visible on the board. It is the demo's first real delegated session and proves the live `agent_run.start` path before broader fan-out.
